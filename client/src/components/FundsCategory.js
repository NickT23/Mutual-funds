...
class FundsCategory extends Component {
  ...
  render() {
    ...
    if (this.state.wantToInvest)
      return <Invest handleRemove={this.handleInvestment} />;
    else
      return (
        <div className="funds-category">
          <header className="header">
            <img src="/images/logo.png" className="logo-img" alt="logo" />
            <button className="invest-btn" onClick={this.handleInvestment}>
              Want To Invest?
            </button>
          </header>
          {funds.length ? (
            ...
            <div className="hero">
              ...
              <button
                className="invest-btn btn-center"
